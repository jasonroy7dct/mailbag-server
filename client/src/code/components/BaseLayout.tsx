...
class BaseLayout extends Component {
  ...
  /** 
   * Initializing state using the createState function with 'this' as an argument.
   * createState is a function responsible for creating the initial state and mutator functions.
   */
