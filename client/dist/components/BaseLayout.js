...
class BaseLayout extends react_1.Component {
    constructor() {
        super(...arguments);
        this.state = (0, state_1.createState)(this);
    }
    render() {
        return (react_1.default.createElement("div", { className: "appContainer" },
            react_1.default.createElement(Dialog_1.default, { open: this.state.pleaseWaitVisible, disableEscapeKeyDown: true, transitionDuration: 0 },
                react_1.default.createElement(DialogTitle_1.default, { style: { textAlign: "center" } }, "Please Wait"),
                react_1.default.createElement(DialogContent_1.default, null,
                    react_1.default.createElement(DialogContentText_1.default, null, "...Contacting to the server..."))),
